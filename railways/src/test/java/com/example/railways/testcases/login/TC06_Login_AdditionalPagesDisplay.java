...
public class TC06_Login_AdditionalPagesDisplay extends BaseTest {
    ...
    public void TC_Login_ValidAccount_AdditionalPagesDisplay() {
        ...
        softAssert.assertTrue(homePage.isDisplayed(Tab.MY_TICKET), AssertMessage.ELEMENT_NOT_DISPLAYED.getMsg() + Tab.MY_TICKET.getName());
        softAssert.assertTrue(homePage.isDisplayed(Tab.CHANGE_PASSWORD), AssertMessage.ELEMENT_NOT_DISPLAYED.getMsg() + Tab.CHANGE_PASSWORD.getName());
        softAssert.assertTrue(homePage.isDisplayed(Tab.LOGOUT), AssertMessage.ELEMENT_NOT_DISPLAYED.getMsg() + Tab.LOGOUT.getName());

        homePage.clickTab(Tab.MY_TICKET);
        ...
        myTicketPage.clickTab(Tab.CHANGE_PASSWORD);
